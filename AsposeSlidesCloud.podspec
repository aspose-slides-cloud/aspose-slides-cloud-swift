...
This is a library for communication with Aspose.Slides Cloud REST API. Its methods are wrappers for corresponding HTTP calls.
  ...
  s.homepage         = 'https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Swift'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Victor Putrov' => 'victor.putrov@aspose.com' }
  s.source           = { :git => 'https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Swift.git', :tag => s.version.to_s }
  s.platform = :osx
